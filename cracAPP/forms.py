...
class createUser(forms.ModelForm):
    ...
    class Meta:
        model = Usuario
        fields = ['nombreUsuario','nombre', 'apellido', 'contrasenia', 'ci', 'ciudad','telefono', 'fechaNacimiento', 'mail']
        widgets = {
            'nombreUsuario': forms.TextInput(attrs={'class': 'form-control mt-3', 'placeholder': 'Nombre de usuario', 'max_length': '15'}),
