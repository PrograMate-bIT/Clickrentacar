...
class Request(models.Model):
    ...
    transportPublisher=models.ForeignKey(VechiclePublication, verbose_name="id", blank=False, null=False, on_delete=models.CASCADE)
    ...
    State = models.CharField(max_length=1, default='S', null=True, blank=True)#estado de la solicitud C=confiormado S=solicitado C=Cancelado
